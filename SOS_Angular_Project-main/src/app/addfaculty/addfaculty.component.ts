...
export class AddfacultyComponent implements OnInit {
  ...
  preload() {
    ...
    this.service.preload( function (res, error) {
      ...
      _self.collegepreload= res.collegeload,
      _self.subjectpreload = res.subpreload,
      _self.courseprelaod = res.coursedata;
      console.log("------------------------->",_self.subjectpreload, _self.courseprelaod)
    });
